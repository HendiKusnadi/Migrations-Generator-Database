...
<body>
   <nav class="navbar navbar-expand-lg navbar-dark bg-danger bg-gradient">
      <div class="container">
         <a class="navbar-brand" href="<?= base_url() ?>">MIGRATE GENERATOR V1.1 by Almaira Studio</a>
   ...
   <div class="container mt-4">
      <?= $contents; ?>
      <!-- footer -->
      <footer class="mt-4 text-muted">Almaira Studio &copy; 2021. CV. Almaira Indonesia</footer>
   </div>
